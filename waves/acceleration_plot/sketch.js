...
function draw(){
  ...
  stroke(0,255,0);
  line(xPos - 3, 5*windowHeight/6-map(pRotationZ,0,360,-windowHeight/6,windowHeight/6), xPos,5*windowHeight/6-map(rotationZ,-180,180,-windowHeight/6,windowHeight/6))
