...
function draw(){
  ...
  stroke(0,0,255);
  line(xPos - 3, 5*windowHeight/6-map(pRotationX,-180,180,-windowHeight/6,windowHeight/6), xPos,5*windowHeight/6-map(rotationX,-40,40,-windowHeight/6,windowHeight/6))
